...
class MyDio {
  ...
  MyDio() {
    BaseOptions options = BaseOptions(
      ...
      baseUrl: 'https://yapi.pro/mock/65063/showPublishedPost',
  ...
  Future<Response> delete(String path, dynamic data, {Options? options}) async {
    try {
      Response response = await _dio.delete(path, data: data, options: options);
      return response;
    } on DioException catch (error) {
      _handleError(error);
      rethrow;
...
//   MyDio myDio = MyDio();
//   try {
//     Response response = await myDio.put('/teladress', {'mobile': 15527700309});
//     print(response.data);
//   } catch (error) {
//     print('请求失败: $error');
//   }
